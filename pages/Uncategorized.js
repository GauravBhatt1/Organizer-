...
import { SearchIcon, FileIcon } from '../lib/icons.js';
                ...
                <div className="space-y-6">
                    <div className="flex gap-3">
                        <${Input} 
                            ...
                            autoFocus
                        />
                        <${Button} onClick=${handleSearch} isLoading=${isSearching} className="self-end h-[42px]" icon=${html`<${SearchIcon} />`}>Search</${Button}>
                    </div>
